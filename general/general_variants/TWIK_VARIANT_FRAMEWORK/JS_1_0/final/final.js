...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _utils_shortcuts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/shortcuts */ "./src/utils/shortcuts.js");
/* harmony import */ var _constants_env__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../constants/env */ "./src/constants/env.js");
...
const displayPopup = () => {
  console.log("display");
  $tw(_constants_selectors__WEBPACK_IMPORTED_MODULE_2__.default.POPUP).fadeIn();
  $tw(_constants_selectors__WEBPACK_IMPORTED_MODULE_2__.default.OVERLAY).fadeIn();
};

const hidePopup = () => {
  console.log("hide");
  (0,_utils_shortcuts__WEBPACK_IMPORTED_MODULE_0__.qSel)(_constants_selectors__WEBPACK_IMPORTED_MODULE_2__.default.POPUP).style.display = "none";
  (0,_utils_shortcuts__WEBPACK_IMPORTED_MODULE_0__.qSel)(_constants_selectors__WEBPACK_IMPORTED_MODULE_2__.default.OVERLAY).style.display = "none";
};
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({ twikPopupWrapper_click, twikOverlay_click });
...
.twik-popup-wrapper {
  ...
  z-index: 99999999999; }
  .twik-popup-wrapper .twik-popup {
    width: 100%;
    height: 100%; }
    .twik-popup-wrapper .twik-popup .twik-container {
      display: flex;
      align-items: center;
      justify-content: center;
      width: 100%;
      height: 100%; }
      .twik-popup-wrapper .twik-popup .twik-container .twik-wrapper {
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (`
<div class="twik-overlay" style="display: none"></div>
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (`
<div class="twik-popup-wrapper" style="display: none">
  <div class="twik-popup">
    <div class="twik-container">
      <div class="twik-wrapper" id="{{greeting_id}}">{{greeting}}</div>
    </div>
  </div>
</div>
`);
...
/* harmony export */   "insAdjHTML": () => (/* binding */ insAdjHTML),
/* harmony export */   "insAdjEl": () => (/* binding */ insAdjEl)
/* harmony export */ });
// shortcuts
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getShopifyCart_fetch": () => (/* binding */ getShopifyCart_fetch),
/* harmony export */   "getTwikJson_fetch": () => (/* binding */ getTwikJson_fetch)
/* harmony export */ });
// #############################################################################################################
//
// GET SHOPIFY CART
...
/* harmony export */   "get_CSS_Selector": () => (/* binding */ get_CSS_Selector),
/* harmony export */   "addFontAwesome": () => (/* binding */ addFontAwesome),
/* harmony export */   "add_or_locate_jQuery": () => (/* binding */ add_or_locate_jQuery),
 ...
 * @returns
 */
const add_or_locate_jQuery = (mainJS) => {
  if (!window.jQuery) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_shortcuts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/shortcuts */ "./src/utils/shortcuts.js");
/* harmony import */ var _utils_useful_functions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/useful_functions */ "./src/utils/useful_functions.js");
/* harmony import */ var _utils_useful_fetches__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/useful_fetches */ "./src/utils/useful_fetches.js");
/* harmony import */ var _js_eventListeners__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/eventListeners */ "./src/js/eventListeners.js");
/* harmony import */ var _js_displayHide__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/displayHide */ "./src/js/displayHide.js");
/* harmony import */ var _constants_env__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./constants/env */ "./src/constants/env.js");
...
/* harmony import */ var _constants_conditions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./constants/conditions */ "./src/constants/conditions.js");
/* harmony import */ var _temp_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./temp/css */ "./src/temp/css.js");
/* harmony import */ var _temp_overlay_html__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./temp/overlay.html */ "./src/temp/overlay.html.js");
/* harmony import */ var _temp_popup_html__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./temp/popup.html */ "./src/temp/popup.html.js");
 ...
 */
// injecting CSS
(0,_utils_shortcuts__WEBPACK_IMPORTED_MODULE_0__.insAdjHTML)(
  document.head,
  "beforeend",
  `<style class="twik-style">${_temp_css__WEBPACK_IMPORTED_MODULE_8__.default}</style>`
);

// injecting HTML
(0,_utils_shortcuts__WEBPACK_IMPORTED_MODULE_0__.insAdjHTML)(document.body, "beforeend", _temp_overlay_html__WEBPACK_IMPORTED_MODULE_9__.default);
(0,_utils_shortcuts__WEBPACK_IMPORTED_MODULE_0__.insAdjHTML)(document.body, "beforeend", (0,_utils_useful_functions__WEBPACK_IMPORTED_MODULE_1__.interp)(_temp_popup_html__WEBPACK_IMPORTED_MODULE_10__.default, data));
 ...
 */
(0,_utils_shortcuts__WEBPACK_IMPORTED_MODULE_0__.addE)((0,_utils_shortcuts__WEBPACK_IMPORTED_MODULE_0__.qSel)(_constants_selectors__WEBPACK_IMPORTED_MODULE_6__.default.POPUP), "click", _js_displayHide__WEBPACK_IMPORTED_MODULE_4__.default.hidePopup);
(0,_utils_shortcuts__WEBPACK_IMPORTED_MODULE_0__.addE)((0,_utils_shortcuts__WEBPACK_IMPORTED_MODULE_0__.qSel)(_constants_selectors__WEBPACK_IMPORTED_MODULE_6__.default.OVERLAY), "click", _js_displayHide__WEBPACK_IMPORTED_MODULE_4__.default.hidePopup);
if (eval(_constants_conditions__WEBPACK_IMPORTED_MODULE_7__.default.IF_TEST)) {
  $tw(document).on("mouseleave", _js_displayHide__WEBPACK_IMPORTED_MODULE_4__.default.displayPopup);
}
(0,_utils_shortcuts__WEBPACK_IMPORTED_MODULE_0__.addE)(window, "click", () => console.log("click"));
